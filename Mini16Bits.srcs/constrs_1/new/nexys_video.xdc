...
## FPGA Configuration I/O Options and SPI flash booting
set_property CONFIG_VOLTAGE 3.3 [current_design];
set_property CFGBVS VCCO [current_design];
set_property BITSTREAM.GENERAL.COMPRESS TRUE [current_design];
set_property BITSTREAM.CONFIG.CONFIGRATE 33 [current_design];
set_property CONFIG_MODE SPIx4 [current_design]; # Cmod A7 comes with either n25q32-3.3v-spix1_x2_x4 or the mx25l3273f

## Master Clock: 12 MHz
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS33} [get_ports clk];
create_clock -period 83.333 -name clk_12m [get_ports clk];

## External Clock: 100 MHz
#set_property -dict {PACKAGE_PIN W5 IOSTANDARD LVCMOS33} [get_ports clk]; #PIO36
#create_clock -period 10.000 -name clk_100m -add [get_ports clk];
#set_input_delay -clock clk_100m 1 [all_inputs]

## LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L12N_T1_MRCC_16 Sch=led[1]		BANK 16 LD1
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_L13P_T2_MRCC_16 Sch=led[2]		BANK 16 LD2
#set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS33 } [get_ports { led0_b }]; #IO_L14N_T2_SRCC_16 Sch=led0_b		BANK 16
#set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { led0_g }]; #IO_L13N_T2_MRCC_16 Sch=led0_g		BANK 16
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { led0_r }]; #IO_L14P_T2_SRCC_16 Sch=led0_r		BANK 16

## Buttons
#set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { btn[0] }]; #IO_L19N_T3_VREF_16 Sch=btn[0]		BANK 16 BTN0
#set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L19P_T3_16 Sch=btn[1]			BANK 16 BTN0
...
## UART 9600
#set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports data_out]
#set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS33} [get_ports data_in]
...
#set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { MemDB[8] }]; #IO_L16P_T2_34 Sch=pio[41]
#set_property -dict { PACKAGE_PIN U2    IOSTANDARD LVCMOS33 } [get_ports { MemDB[9] }]; #IO_L9N_T1_DQS_34 Sch=pio[42]
#set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { MemDB[10] }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
#set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { MemDB[11] }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { MemDB[12] }]; #IO_L19P_T3_34 Sch=pio[45]
#set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { MemDB[13] }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { MemDB[14] }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { MemDB[15] }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
#set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33 } [get_ports { RamOEn     }]; #IO_L10P_T1_D14_14 Sch=sram-oe - Output enable (active-low)
#set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports { RamWEn     }]; #IO_L10N_T1_D15_14 Sch=sram-we - Write enable (active-low)
#set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS33 } [get_ports { RamCEn     }]; #IO_L9N_T1_DQS_D13_14 Sch=sram-ce - Chip enable (active-low)

## Recomended HDMI Output (Source)
#set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports hdmi_tx_cec]; #IO_L14P_T2_SRCC_34 Sch=pio[47]				BANK 34
#set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports hdmi_tx_hpd]; #IO_L14N_T2_SRCC_34 Sch=pio[48]				BANK 34
#set_property -dict {PACKAGE_PIN U4	IOSTANDARD LVCMOS33 } [get_ports hdmi_tx_hpd]; #IO_L11P_T1_SRCC_34 Sch=pio[38]				BANK 34
#set_property -dict {PACKAGE_PIN V4 IOSTANDARD LVCMOS33} [get_ports hdmi_tx_rscl]; #IO_L11N_T1_SRCC_34 Sch=pio[37]				BANK 34
#set_property -dict {PACKAGE_PIN W4 IOSTANDARD LVCMOS33} [get_ports hdmi_tx_rsda]; #IO_L12N_T1_MRCC_34 Sch=pio[40]				BANK 34
#set_property -dict {PACKAGE_PIN U2   IOSTANDARD TMDS_33 } [get_ports {hdmi_tx_clk_n}]; #IO_L9N_T1_DQS_34 Sch=pio[42]			BANK 34
#set_property -dict {PACKAGE_PIN U3   IOSTANDARD TMDS_33 } [get_ports {hdmi_tx_clk_p}]; #IO_L9P_T1_DQS_34 Sch=pio[44]			BANK 34
#set_property -dict {PACKAGE_PIN T2   IOSTANDARD TMDS_33 } [get_ports {hdmi_tx_n[0] }]; #IO_L1N_T0_34 Sch=pio[30]				BANK 34
#set_property -dict {PACKAGE_PIN R2   IOSTANDARD TMDS_33 } [get_ports {hdmi_tx_p[0] }]; #IO_L1P_T0_34 Sch=pio[28]				BANK 34
#set_property -dict {PACKAGE_PIN T3   IOSTANDARD TMDS_33 } [get_ports {hdmi_tx_n[1] }]; #IO_L2N_T0_34 Sch=pio[27]				BANK 34
#set_property -dict {PACKAGE_PIN R3   IOSTANDARD TMDS_33 } [get_ports {hdmi_tx_p[1] }]; #IO_L2P_T0_34 Sch=pio[26]				BANK 34
#set_property -dict {PACKAGE_PIN W2   IOSTANDARD TMDS_33 } [get_ports {hdmi_tx_n[2] }]; #IO_L5N_T0_34 Sch=pio[32]				BANK 34
#set_property -dict {PACKAGE_PIN V2   IOSTANDARD TMDS_33 } [get_ports {hdmi_tx_p[2] }]; #IO_L5P_T0_34 Sch=pio[33]				BANK 34
